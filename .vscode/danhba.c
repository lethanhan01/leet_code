...
void ThemPT()
{
    ...
    char tmpEmail[32] = { 0 };
    fflush(stdin);
    printf("Name: "); fgets(tmpName, sizeof(tmpName) - 1, stdin);
    fflush(stdin);
    printf("Tel: "); fgets(tmpTel, sizeof(tmpTel) - 1, stdin);
    fflush(stdin);
    printf("Email: "); fgets(tmpEmail, sizeof(tmpEmail) - 1, stdin);
...
void ChenPT()
{
    ...
    printf("After Tel: "); fgets(tmpTel, sizeof(tmpTel) - 1, stdin);
...
void XoaPT()
{
    char tmpTel[32] = { 0 };
    fflush(stdin);
    printf("Tel to remove: "); fgets(tmpTel, sizeof(tmpTel) - 1, stdin);
    CONTACT* tmp = TimTel(tmpTel);
    if (tmp != NULL)
    {
        if (pPrevious == NULL)
